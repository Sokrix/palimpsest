---
mode: agent
description: 'Ingest — Canonicalize raw/ and sessions/ into topical buckets'
---
...
The classification rubric for the three buckets lives in `~/.copilot/instructions/palimpsest.instructions.md` under "wiki/ structure — the three topical buckets". Apply it strictly. When in doubt, ask the user before writing.
...
- Apply the bucket rubric from `~/.copilot/instructions/palimpsest.instructions.md` strictly; ask the user when content fits no bucket
